  ...
  experiences: [
    {
      ...
      descriptionEs:
        "Arquitecté y construí EfiziAI a lo largo de su evolución de producto. Primera etapa (CRM): plataforma SaaS B2B full-stack para gestión de leads con IA — API REST en Node.js/Express, CRM en React/Vite, PostgreSQL, reverse proxy Traefik en VPS y contenerización con Docker; Claude API para scoring de leads, n8n para automatización, WhatsApp para outreach y webhooks de Hotmart (HMAC-SHA256) para activación de planes, con modelo freemium, RBAC y auditoría. Etapa actual (pivote a voz): reorienté el producto a una recepcionista de voz IA telefónica que atiende llamadas y agenda citas de forma autónoma, con una arquitectura LEAN de bajo costo — Retell (voz), Twilio (telefonía), Claude Haiku (razonamiento conversacional), Cal.com (agendamiento) y n8n, sobre PostgreSQL self-host en VPS.",
      descriptionEn:
        "Architected and built EfiziAI across its product evolution. First stage (CRM): a full-stack B2B SaaS platform for AI-powered lead management — Node.js/Express REST API, React/Vite CRM, PostgreSQL, Traefik reverse proxy on a VPS, Docker-containerized; Claude API for lead scoring, n8n for automation, WhatsApp for outreach, and Hotmart webhooks (HMAC-SHA256) for plan activation, with a freemium model, RBAC and audit logging. Current stage (pivot to voice): re-oriented the product into an AI phone-voice receptionist that answers calls and books appointments autonomously, on a lean low-cost architecture — Retell (voice), Twilio (telephony), Claude Haiku (conversational reasoning), Cal.com (scheduling) and n8n, over self-hosted PostgreSQL on a VPS.",
      technologies: ["Retell", "Twilio", "Claude Haiku", "Cal.com", "n8n", "PostgreSQL", "Node.js", "React", "Docker", "Claude API", "WhatsApp API", "Hotmart"],
      startDate: "Ene 2025",
  ...
  skills: [
    {
      categoryEs: "Frontend",
      categoryEn: "Frontend",
      items: ["React.js", "Angular 21", "Next.js", "TypeScript", "JavaScript", "jQuery", "CSS3", "Bootstrap", "Tailwind CSS"],
    },
    {
      categoryEs: "Backend",
      categoryEn: "Backend",
