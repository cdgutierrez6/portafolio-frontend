...
export const i18n = {
  es: {
    ...
    contact: {
      ...
      sending: "Enviando…", sent: "✅ Mensaje enviado correctamente",
      sendError: "❌ Error al enviar", mailFallback: "✉️ Abrimos tu correo con el mensaje listo para enviar",
      copy: "Copiar", copiedShort: "✓ Copiado", copiedToast: "copiado", copyFailed: "No se pudo copiar",
    },
  ...
  en: {
    ...
    contact: {
      ...
      sending: "Sending…", sent: "✅ Message sent successfully",
      sendError: "❌ Failed to send", mailFallback: "✉️ We opened your email with the message ready to send",
      copy: "Copy", copiedShort: "✓ Copied", copiedToast: "copied", copyFailed: "Couldn't copy",
    },
